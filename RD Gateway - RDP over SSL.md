...
The same solution has always allowed for the option to "Connect to a remote PC" via the Web Interface, using the url `https://[yourdomain]/RDWeb/Pages/en-US/desktops.aspx` 
